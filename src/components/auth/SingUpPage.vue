      ...
      <div class="signup-container">
        ...
        <div class="form-section">
          ...
          <div class="form-group">
            ...
            <div class="gender-buttons">
              <button class="button gender-button active">남성</button>
              <button class="button gender-button">여성</button>
            </div>
          </div>
        ...
        <div class="checkbox-section">
          <div class="checkbox-wrapper">
            ...
            <label for="privacy" class="checkbox-label">개인정보 처리방침 동의</label>
          </div>
          <div class="checkbox-wrapper">
            <input type="checkbox" id="terms" class="checkbox-input" />
            <label for="terms" class="checkbox-label">이용약관 동의</label>
          </div>
        </div>
